<div class="row">
    <div class="col-sm-7">
        <div id="imgnameandcontroller">
            ...
            <span id="audio">
                <audio controls class="thecontroller" autoplay onended="kanipe()">
    ...
    <div class="col-sm-1">
        <div id="prevandnextbtn">
            <div id="bottomprevbtn" class="fas fa-step-backward" onclick="dupe()"></div>
            <div id="bottomnextbtn" class=" fas fa-step-forward " onclick="kanipe()"></div>
        </div>
    </div>

    <div class="col-sm-4">
        <div id="downloadbuttonandicon">
            <a id="downloadbutton" href="/practice1(music player)/allmusic/asake/Asake - Joha (Official).mp3" download>
