<div class="row">
    <div class="col-sm-7">
        <div id="imgnameandcontroller">
            ...
            <h5 id="thename">Dull<br> <small id="theartist" onclick="">Asake</small></h5>

            <span id="audio">
                <audio controls class="thecontroller" autoplay onended="dupe()">
                    <source
    ...
    <div class="col-sm-1">
        <div id="prevandnextbtn">
            <div id="bottomprevbtn" class="fas fa-step-backward" onclick="asakeBody()"></div>
            <div id="bottomnextbtn" class=" fas fa-step-forward " onclick="dupe()"></div>
        </div>
    </div>
